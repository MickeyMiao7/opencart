      ...
      <table class="form">
        <tr>
          ...
          <td style="text-align: right;">
            ...
            <a href="<?php echo ($export . '&filter_date_start=' . $filter_date_start . '&filter_date_end=' . $filter_date_end . '&filter_group=' . $filter_group . '&filter_order_status_id=' . $filter_order_status_id . '&filter_customer_name=' . $filter_customer_name .'&filter_referrer_name=' . $filter_referrer_name . '&page=' . $page) ; ?>" class="button">
