    ...
    <div class="content">
      <table class="form">
        <tr>
          ...
          <a href="<?php echo ($export . '&filter_date_start=' . $filter_date_start . '&filter_date_end=' . $filter_date_end . '&filter_group=' . $filter_group . '&filter_order_status_id=' . $filter_order_status_id . '&page=' . $page) ; ?>" class="button">
